...
do
    ...
    # gunzip the bugger
    gunzip ${input_dir}/${input_var1}/crujra.v2.0.5d.${input_var1}.${year}.365d.noc.nc.gz
    gunzip ${input_dir}/${input_var2}/crujra.v2.0.5d.${input_var2}.${year}.365d.noc.nc.gz

    # combine u and v windspeeds into a single file
    cdo  merge ${input_dir}/${input_var1}/crujra.v2.0.5d.${input_var1}.${year}.365d.noc.nc ${input_dir}/${input_var2}/crujra.v2.0.5d.${input_var2}.${year}.365d.noc.nc  ${output_dir}/temporary_wind.${year}.nc
    ...
    # re-gzip 
    gzip ${input_dir}/${input_var1}/crujra.v2.0.5d.${input_var1}.${year}.365d.noc.nc
    gzip ${input_dir}/${input_var2}/crujra.v2.0.5d.${input_var2}.${year}.365d.noc.nc
